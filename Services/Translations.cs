...
public static class Translations
{
    ...
    private static readonly Dictionary<string, Pair> Map = new()
    {
        ...
        ["nav.stockTakes"] = new("Kiểm kê", "Stocktakes"),
        ...
        // Stocktakes
        ["stockTakes.title"] = new("Kiểm kê kho", "Stocktakes"),
        ["stockTakes.create"] = new("Tạo phiếu kiểm kê", "New stocktake"),
        ["stockTakes.detail"] = new("Phiên kiểm kê", "Stocktake"),
        ["stockTakes.searchHint"] = new("Tìm vị trí / người tạo / ghi chú...", "Search location / user / note..."),
        ["stockTakes.location"] = new("Vị trí kiểm kê", "Location to count"),
        ["stockTakes.note"] = new("Ghi chú", "Note"),
        ["stockTakes.pickLocationFirst"] = new("Chọn vị trí để tải danh sách hàng cần đếm.", "Pick a location to load the items to count."),
        ["stockTakes.countSheet"] = new("Phiếu đếm", "Count sheet"),
        ["stockTakes.addProduct"] = new("Thêm sản phẩm ngoài danh sách", "Add product not listed"),
        ["stockTakes.emptyLocation"] = new("Vị trí này chưa có tồn kho. Dùng ô bên trên để thêm sản phẩm đếm được.", "No stock recorded here. Use the box above to add products you counted."),
        ["stockTakes.systemQty"] = new("Tồn hệ thống", "System qty"),
        ["stockTakes.countedQty"] = new("Đếm thực tế", "Counted qty"),
        ["stockTakes.variance"] = new("Chênh lệch", "Variance"),
        ["stockTakes.varianceSummary"] = new("Dòng có chênh lệch", "Lines with variance"),
        ["stockTakes.varianceLines"] = new("Dòng lệch", "Variance lines"),
        ["stockTakes.netVariance"] = new("Chênh lệch ròng", "Net variance"),
        ["stockTakes.lines"] = new("Số dòng", "Lines"),
        ["stockTakes.submit"] = new("Lưu phiếu kiểm kê", "Save stocktake"),
        ["stockTakes.created"] = new("Đã tạo phiên kiểm kê. Tồn kho chưa thay đổi cho tới khi đối chiếu.", "Stocktake created. Stock is unchanged until you reconcile."),
        ["stockTakes.createFailed"] = new("Tạo phiên kiểm kê thất bại", "Could not create the stocktake"),
        ["stockTakes.statusInProgress"] = new("Đang kiểm", "In progress"),
        ["stockTakes.statusCompleted"] = new("Đã đối chiếu", "Reconciled"),
        ["stockTakes.complete"] = new("Đối chiếu & điều chỉnh", "Reconcile stock"),
        ["stockTakes.completing"] = new("Đang đối chiếu...", "Reconciling..."),
        ["stockTakes.completed"] = new("Đã điều chỉnh tồn kho theo số đếm thực tế.", "Stock adjusted to the counted quantities."),
        ["stockTakes.completeFailed"] = new("Đối chiếu thất bại", "Reconciliation failed"),
        ["stockTakes.confirmComplete"] = new("Tồn kho sẽ được ghi đè bằng số đếm thực tế. Thao tác này không thể hoàn tác. Tiếp tục?", "On-hand quantities will be overwritten with the counted figures. This cannot be undone. Continue?"),
        ["stockTakes.pendingWarning"] = new("Phiên này có chênh lệch nhưng chưa đối chiếu — tồn kho vẫn giữ số cũ.", "This session has variances but has not been reconciled — stock still shows the old figures."),
        ["stockTakes.notFound"] = new("Không tìm thấy phiên kiểm kê", "Stocktake not found"),
        ["stockTakes.none"] = new("Chưa có phiên kiểm kê nào.", "No stocktakes yet."),
